...
?LK_REG		EQU 0x20   ;x20 adresim ilk reg adresim olarak adland?rd?m. Register File içinde çal???r 14 bitli?e dönü?türülür flass belle?e yüklenir 
?K?NC?_REG	EQU 0x21   ;
SONUC_REG	EQU 0x22   ;
...
BASLA
	MOWLW 0x1A  ;1 a say?s?n? omegaya kopyalad?k
	MOVWF ?LK_REG ;omegadaki say?y? ilk_reg de?i?kenine att?k 
